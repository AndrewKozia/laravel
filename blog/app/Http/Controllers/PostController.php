...
class PostController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (!$post) {
            return redirect()->route('post.index')->withErrors('Данного поста еще не существует.');
        }
    ...
    public function edit($id)
    {
        ...
        if ($post->author_id != \Auth::user()->id) {
            return redirect()->route('post.index')->withErrors('Вы не можете редлактировать данный пост, т.к. не являетесь его автором.');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($post->author_id != \Auth::user()->id) {
            return redirect()->route('post.index')->withErrors('Вы не можете удалить данный пост, т.к. не являетесь его автором.');
        }
